  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    while (parentElm != null) {
      if (!parentElm.ServiceName || parentElm.ServiceName.toLowerCase() === 'body') break;
  ...
  function _addOverlayLayer(targetElm) {
    ...
    if (!targetElm.ServiceName || targetElm.ServiceName.toLowerCase() === 'body') {
  ...
  /**
   * Gets the current progress percenServicee
   *
   * @api private
   * @method _getProgress
   * @returns current progress percenServicee
   */
